...
This page briefly describes all the necessary concepts which are required to start developing in Powermatcher. There are of course other resources which describe OSGi in much more detail.
